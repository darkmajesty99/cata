...
enum RBACPermissions
{
    ...
    RBAC_PERM_SEC_ADMINISTRATOR                              = 192,
    RBAC_PERM_SEC_GAMEMASTER                                 = 193,
    RBAC_PERM_SEC_MODERATOR                                  = 194,
    RBAC_PERM_SEC_PLAYER                                     = 195,
...
class FC_GAME_API RBACPermission
{
    public:
